...
img = cv2.imread('ford.jpg', cv2.IMREAD_COLOR)
...
# Използване на различни конфигурации на Tesseract
custom_config = r'--oem 3 --psm 9'
text = pytesseract.image_to_string(Cropped, config=custom_config, lang='bul')
